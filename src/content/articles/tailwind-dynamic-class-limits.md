...
---
> 🗓️ 文档整理时间：2026 年 6 月 | 来源：[Tailwind CSS 官方文档](https://tailwindcss.com/docs/content-configuration#dynamic-class-names) / [Astro 指令参考](https://docs.astro.build/en/reference/directives-reference/#classlist)
